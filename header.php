...
<div id="page" class="site">
	...
	<?php (is_front_page() || is_page_template( 'template-diensten.php' ) || is_page_template( 'template-overons.php' ) || is_page_template( 'template-contact.php' )) ? $container = 'container-fluid' : $container = 'container'; ?>
